...
## Installation
    ...
    $ go get github.com/opentoys/sqlite

## Documentation

[pkg.go.dev/github.com/opentoys/sqlite](https://pkg.go.dev/github.com/opentoys/sqlite)

## Builders

[modern-c.appspot.com/-/builder/?importpath=github.com/opentoys/sqlite%2fsqlite](https://modern-c.appspot.com/-/builder/?importpath=github.com/opentoys/sqlite%2fsqlite)

## Speedtest1

Numbers for the pure Go version were produced by

     ~/src/github.com/opentoys/sqlite/speedtest1$ go build && ./speedtest1

Numbers for the pure C version were produced by

     ~/src/github.com/opentoys/sqlite/testdata/sqlite-src-3410200/test$ gcc speedtest1.c ../../sqlite-amalgamation-3410200/sqlite3.c -lpthread -ldl && ./a.out
