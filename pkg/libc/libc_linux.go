...
package libc // import "github.com/opentoys/sqlite/pkg/libc"
...
import (
	...
	guuid "github.com/opentoys/sqlite/pkg/uuid"
	"github.com/opentoys/sqlite/pkg/unix"
	"github.com/opentoys/sqlite/pkg/libc/errno"
	"github.com/opentoys/sqlite/pkg/libc/fcntl"
	"github.com/opentoys/sqlite/pkg/libc/fts"
	gonetdb "github.com/opentoys/sqlite/pkg/libc/honnef.co/go/netdb"
	"github.com/opentoys/sqlite/pkg/libc/langinfo"
	"github.com/opentoys/sqlite/pkg/libc/limits"
	"github.com/opentoys/sqlite/pkg/libc/netdb"
	"github.com/opentoys/sqlite/pkg/libc/netinet/in"
	"github.com/opentoys/sqlite/pkg/libc/signal"
	"github.com/opentoys/sqlite/pkg/libc/stdio"
	"github.com/opentoys/sqlite/pkg/libc/sys/socket"
	"github.com/opentoys/sqlite/pkg/libc/sys/stat"
	"github.com/opentoys/sqlite/pkg/libc/sys/types"
	"github.com/opentoys/sqlite/pkg/libc/termios"
	ctime "github.com/opentoys/sqlite/pkg/libc/time"
	"github.com/opentoys/sqlite/pkg/libc/unistd"
	"github.com/opentoys/sqlite/pkg/libc/uuid/uuid"
)
...
func Xopenat(t *TLS, dirfd int32, pathname uintptr, flags int32, mode types.Mode_t) int32 {
	...
	// From github.com/opentoys/sqlite/pkg/unix/zsyscall_linux.go
...
func Xfchmodat(t *TLS, dirfd int32, pathname uintptr, mode types.Mode_t, flags int32) int32 {
	...
	// From github.com/opentoys/sqlite/pkg/unix/syscall_linux.go
